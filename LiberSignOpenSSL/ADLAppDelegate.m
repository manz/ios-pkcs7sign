...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
   ...
   // [[NSFileManager defaultManager]]
    ...
    NSString *p12path = [[NSBundle mainBundle] pathForResource:@"manz@ringum.net" ofType:@"p12"];
    
    NSData *data = [NSData dataWithContentsOfFile:@"/tmp/toto"];
    
    //[blob importP12:p12path withPassword:@"Napha7ad!"];
    
    ADLKeyStore *ks = [[ADLKeyStore alloc] init];
    ks.managedObjectContext = self.managedObjectContext;
    [ks resetKeyStore];
    [ks addKey:p12path withPassword:@"Napha7ad!" andData:data];
    NSArray *keys = [[ks listPrivateKeys] retain];
